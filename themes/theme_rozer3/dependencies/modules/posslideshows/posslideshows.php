        ...
        for ($i = 1; $i <= 2; ++$i) {
            ...
            foreach ($languages as $language) {
				...
				if($i==1){
					...
					$slide->description[$language['id_lang']] = '{"1":{"title":"New small ipad pro","display":"3","animation":"6"},"2":{"title":"iPad Pro 9-inch","display":"0","animation":"7"},"3":{"title":"Now Available","display":"0","animation":"8"},"4":{"title":"Shop Now","display":"5","animation":"10"}}';
				}elseif($i==2){
					$slide->title = 'slide show2';
					$slide->cap_position = 1;
					$slide->description[$language['id_lang']] = '{"1":{"title":"Wireless bluetooth gaming","display":"3","animation":"7"},"2":{"title":"Wireless Gamepad","display":"0","animation":"8"},"3":{"title":"IPEGA PG-9023","display":"0","animation":"9"},"4":{"title":"Shop Now","display":"5","animation":"10"}}';
				}else{
