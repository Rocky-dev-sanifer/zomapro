...
class PosThemeoptions extends Module implements WidgetInterface
{
    ...
    public function install()
    {
		$this->createHooks();
        //General
        Configuration::updateValue($this->name . 'g_main_color', '#146cda');
        ...
        Configuration::updateValue($this->name . 'g_body_font_color', '#888888');
        // Configuration::updateValue($this->name . 'g_a_color', '#555555');
        // Configuration::updateValue($this->name . 'g_a_colorh', '#146cda');
        ...
        Configuration::updateValue($this->name . 'g_title_font_color', '#1d1d1d');
        ...
        // Configuration::updateValue($this->name . 'g_button_bgcolorh', '#146cda');
        ...
        // Configuration::updateValue($this->name . 'g_footer_a_colorh', '#146cda');
        // Product
        Configuration::updateValue($this->name . 'p_display', 0);
        Configuration::updateValue($this->name . 'p_name_color', '#47494a');
        Configuration::updateValue($this->name . 'p_name_colorh', '#146cda');
        ...
        Configuration::updateValue($this->name . 'p_price_color', '#1d1d1d');
        ...
        // Product page
        Configuration::updateValue($this->name . 'pp_thumbnail', 1);
        Configuration::updateValue($this->name . 'pp_name_color', '#47494a');
        Configuration::updateValue($this->name . 'pp_name_size', 24);
        Configuration::updateValue($this->name . 'pp_name_transform', 2);
        Configuration::updateValue($this->name . 'pp_price_color', '#1d1d1d');
        Configuration::updateValue($this->name . 'pp_price_size', 24);
