        ...
        for ($i = 1; $i <= 2; ++$i) {
            ...
            foreach ($languages as $language) {
				...
				if($i==1){
					...
					$slide->description[$language['id_lang']] = '{"1":{"title":"Summmer sale !","display":"3","animation":"6"},"2":{"title":"Redmi K20 Pro","display":"0","animation":"7"},"3":{"title":"Up to 40% Off","display":"0","animation":"8"},"4":{"title":"Shop Now","display":"5","animation":"10"}}';
				}elseif($i==2){
					$slide->title = 'slide show2';
					$slide->cap_position = 1;
					$slide->description[$language['id_lang']] = '{"1":{"title":"bluetooth speaker","display":"3","animation":"7"},"2":{"title":"Ambrane BT-5000","display":"0","animation":"8"},"3":{"title":"Bluetooth Speaker","display":"0","animation":"9"},"4":{"title":"Shop Now","display":"5","animation":"10"}}';
				}else{
