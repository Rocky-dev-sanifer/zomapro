 ...
 * La confirmation s'affiche en pop-up (modal) par-dessus le formulaire.
 *}
...
{block name='page_content'}
  <div class="zps-wrap">
    ...
    {if $zps_success}
      <div class="zps-modal-overlay" id="zpsModal">
        <div class="zps-modal">
          <button type="button" class="zps-modal-close" aria-label="Fermer" onclick="document.getElementById('zpsModal').style.display='none';">&times;</button>
          <div class="zps-modal-check"><i class="material-icons">check_circle</i></div>
          <p class="zps-modal-text">
            {l s='La validation de votre compte se fera sous un délai de' mod='zomaprosignup'}
            <strong>{l s='24 heures ouvrées.' mod='zomaprosignup'}</strong><br>
            {l s='Pour plus d\'informations, veuillez nous contacter à ce numéro :' mod='zomaprosignup'}<br>
            <strong class="zps-modal-phone">+261 38 90 411 28</strong>
          </p>
        </div>
      </div>
    {/if}
