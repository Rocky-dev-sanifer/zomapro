...
{block name="page_content"}
    ...
    <form action="{$link->getModuleLink('opartdevis', 'simplequotation')|escape:'htmlall':'UTF-8'}" method="post" class="form-horizontal" enctype="multipart/form-data" id="opartDevisForm">
        <div class="panel panel-default">
            ...
            <div class="form-group clear_fix">
                <div class="col-lg-12">
                    ...
                    <textarea class="form-control" row="3" id="quotation_message" name="quotation_message">{if isset($smarty.post.quotation_message)}{$smarty.post.quotation_message nofilter}{/if}</textarea>
                </div>
            </div>
            <!-- /Quotation description -->
           ...
           <div class="form-group clear_fix">
                <div class="col-lg-12">
                    <label for="quotation_file">{l s='Attachments (5MB max) :' mod='opartdevis'}*</label>
                    <input type="hidden" name="MAX_FILE_SIZE" value="5242880">
                      <input id="quotation_file" type="file" name="quotation_file"  enctype="multipart/form-data">
        ...
        <p class="cart_navigation clearfix">
            ...
            <a href="{$urls.base_url|escape:'htmlall':'UTF-8'}" class="btn btn-default button button-small">
            ...
            {if (Configuration::get('OPARTDEVIS_CAPTCHA') && Configuration::get('OPARTDEVIS_CAPTCHA_PUBLIC_KEY') && Configuration::get('OPARTDEVIS_CAPTCHA_PRIVATE_KEY'))}
                ...
                <div class="g-recaptcha col-lg-4" data-sitekey="{Configuration::get('OPARTDEVIS_CAPTCHA_PUBLIC_KEY')|escape:'htmlall':'UTF-8'}"></div>
            {/if}
