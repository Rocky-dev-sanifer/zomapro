    ...
    public function renderForm()
    {
        ...
        $this->fields_form = [
            ...
            'input' => [
                ...
                [
                    'type' => 'switch',
                    'label' => $this->l('Mettre en avant sur la page d\'accueil'),
                    'name' => 'is_home',
                    'desc' => $this->l('Si activé, ce bien apparaîtra dans le bloc "Biens à la une" en page d\'accueil.'),
                    'values' => [['id' => 'on', 'value' => 1], ['id' => 'off', 'value' => 0]],
                ],
                [
                    'type' => 'switch',
