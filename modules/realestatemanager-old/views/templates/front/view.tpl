...
{*$customer|dump*}
{*$property|dump*}
{if $customer && $customer.id_default_group == 4}
<div class="customer-avatar">
  <div>
    <img src="" alt="{$customer.lastname}">
  </div>
  <div>
    <a href="/mon-compte/mes-biens?id-pro={$property->id_customer}">{$owner_name}</a>
  </div>
</div>
{/if}
    <div class="re-detail-grid">
      ...
      <div class="re-detail-info">
        ...
        <ul class="re-detail-availability">
          ...
          {if isset($city_label) && $city_label}<li>Ville : {$city_label|escape:'html':'UTF-8'}</li>{/if}
        </ul>
