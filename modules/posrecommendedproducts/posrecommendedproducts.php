...
class Posrecommendedproducts extends Module implements WidgetInterface
{
    ...
    protected function installFixtures()
    {
        ...
        foreach ($languages as $lang){
            $values['content_title'][(int)$lang['id_lang']] = 'Recently Added';
    ...
    public function getConfigFieldsValues()
    {
        ...
        $fields = array(
            ...
            'content_items_per_lg'      => Configuration::get($this->prefixname . '_ITEMS_PER_LG'),			            'content_items_per_md'      => Configuration::get($this->prefixname . '_ITEMS_PER_MD'),
        ...
        {   
            ...
            $fields['content_description'][$lang['id_lang']] = Tools::getValue('content_description_'.$lang['id_lang'], Configuration::get($this->prefixname . '_DESCRIPTION', $lang['id_lang']));
        }
        return $fields;
    }
    ...
    public function getWidgetVariables($hookName = null, array $configuration = [])
    {
        ...
        $content_options = array(
            ...
            'items_lg' => (int)Configuration::get($this->prefixname . '_ITEMS_PER_LG'), 			            'items_md' => (int)Configuration::get($this->prefixname . '_ITEMS_PER_MD'), 
    ...
    private function findCateProPerContent()
    {
        return array(
            array(
                'name' => 'content_items_per_lg',
                'id' => $this->prefixname . '_ITEMS_PER_LG',
